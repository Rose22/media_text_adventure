...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "MediaTextAdventure.py"
 
        #Name of program
        self.project_name = "MediaTextAdventure Engine"
        ...
        self.license = "Copyrighted"
 
        #Auhor of program
        self.author_name = "Rose22"
        self.author_email = "none@none.com"
        self.copyright = "Copyright (c) 2013 Rose22"
 
        #Description
        self.project_description = "A text adventure engine with multimedia functionality"
